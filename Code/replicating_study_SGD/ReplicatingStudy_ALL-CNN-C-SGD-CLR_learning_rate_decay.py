...
class CyclicLR(tf.keras.callbacks.Callback):
    ...
    def clr(self):
        ...
        if self.scale_mode == 'cycle':
            return (self.base_lr + (self.max_lr-self.base_lr)*np.maximum(0, (1-x))*self.scale_fn(cycle))*self.learning_rate_decay
        else:
...
initializeTraining(0.01,"replicating_study_ALL-CNN-C-SGD-CLR_learning_rate", 350, "hermanPC")
